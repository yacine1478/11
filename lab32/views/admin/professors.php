...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="index.php?page=admin.professors">Professors</a></li>
    ...
    <div class="container mt-4">
        ...
        <div class="card mb-4">
            <div class="card-header">Create Professor Account</div>
            <div class="card-body">
                <form method="POST" action="index.php?page=admin.professors">
                    <div class="row gy-2 align-items-end">
                        ...
                        <div class="col-md-1">
                            <button type="submit" name="action" value="create" class="btn btn-primary w-100">Create</button>
                        </div>
                    </div>
                </form>
                <div class="form-text">Leave password blank to use default <strong>password123</strong>.</div>
            </div>
        </div>
